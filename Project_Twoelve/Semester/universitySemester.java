...
public class universitySemester {
    ...
    public void average_students (){
        ...
        for (Map.Entry<String, ArrayList<String>> size_value : clas.get_set_unit().entrySet()) {
        ...
        for (Map.Entry<String, ArrayList<String>> av_student : clas.get_set_unit().entrySet()) {
